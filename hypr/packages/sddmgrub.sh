...
echo ""
sudo cp $HOME/garuda-dots/sddm/sddm.conf /etc/sddm.conf.d/
sudo cp $HOME/garuda-dots/sddm/sddm.conf /etc/
echo "File /etc/sddm.conf updated."
echo ""
cp ~/garuda-dots/default.png ~/.cache/current-wallpaper.png
echo ""
...
echo ""
echo ""
sudo cp ~/garuda-dots/sddm/theme.conf /usr/share/sddm/themes/Sugar-Candy/
